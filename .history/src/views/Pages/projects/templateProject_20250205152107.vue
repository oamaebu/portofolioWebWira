        ...
        return {
            ...
            projects: [
                ...
                },
                {
                    ...
                    description: "Developing a landing page for a counselling service startup where client can order a counselling service from the website and build an admin page where the admin can update the info about upcoming event, service, testimonym etc",
                      status:"In Progress"
                }
