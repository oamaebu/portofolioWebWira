<template>
            ...
            <div class="content-center mx-4 sm:mx-10 md:mx-20 lg:mx-36 my-10">
                ...
                <button v-if="isActive === 'website'" v-for="(project, index) in projects" :key="index"
                    ...
                    <div class="w-2/5 bg-red-700 h-60 mr-10">
                        <img :src="`/element/project/web/${[project.name]}/${project.img}`" alt="" class="w-full h-full object-cover object-top">
                    </div>
                ...
                <Popup :showPopup="showPopup" @close-popup="closePopup" :selectedName="selectedName" :title="title" :selectedPortofolioType="selectedPortofolioType"  />
    ...
    <img :src="`/element/project/mobile/${[mobile.name]}/${mobile.img}`" alt="" class="h-full object-cover object-top">
</div>
